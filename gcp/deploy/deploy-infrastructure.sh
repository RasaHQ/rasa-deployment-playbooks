...
print_info "Enabling required services on GCP. This might take a few minutes..."
...
gcloud services enable \
  ...
  dns.googleapis.com \
  iam.googleapis.com
print_info "Required services enabled."
...
print_info "Configuring Private Service Access..."
...
print_info "Enabling VPC Peering..."
...
print_info "Assigning roles to GCP Service Account..."
...
print_info "Waiting for GKE Cluster to be up before continuing. This may take a few minutes..."
...
print_info "Creating DNS Service Account..."
...
print_info "Assigning roles to DNS Service Account..."
gcloud projects add-iam-policy-binding $PROJECT_ID \
...
print_info "Creating Rasa Service Account and assigning roles..."
...
gcloud iam service-accounts add-iam-policy-binding $NAME-assistant@$PROJECT_ID.iam.gserviceaccount.com \
  ...
  --role="roles/iam.workloadIdentityUser"
print_info "Rasa Service Account created and configured"

print_info "Creating Rasa Studio Service Account and assigning roles..."
...
print_info "Setting up PostgreSQL instance..."
...
print_info "Network link: $NETWORK_LINK"
...
print_info "Creating PostgreSQL instance..."
print_info "Waiting for PostgreSQL instance to be up before continuing. This may take a few minutes..."
...
gcloud storage buckets create gs://$STUDIO_BUCKET \
  ...
  --uniform-bucket-level-access \
  --public-access-prevention
print_info "Cloud Storage Buckets created."
...
print_info "Assigning service accounts access to Cloud Storage Buckets..."
gcloud projects add-iam-policy-binding $PROJECT_ID \
...
print_info "Waiting for Redis instance to be up before continuing. This may take a few minutes..."
...
print_info "Creating PostgreSQL users and databases..."
...
print_info "PostgreSQL users and databases created."

print_info "Infrastructure deployed! Check the output above for any errors."
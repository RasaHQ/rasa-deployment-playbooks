...
envsubst < "$SCRIPT_DIR/external-dns-secret.template.yaml" > "$SCRIPT_DIR/external-dns-secret.yaml"
...
print_info "Adding a Kubernetes secret with Azure workload identity..."
kubectl apply -f "$SCRIPT_DIR/external-dns-secret.yaml"
